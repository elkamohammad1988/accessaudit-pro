...
// The statement prose lives in `src/i18n/messages/en/legal.json` under
// `accessibility`; adjust the contact address below to match.
...
export default async function AccessibilityPage() {
  ...
  return (
    <>
      ...
      <p>{t("lastReviewed", { date: LAST_REVIEWED })}</p>

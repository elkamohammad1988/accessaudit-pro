...
const variantClasses: Record<Variant, string> = {
  primary:
    "bg-brand text-brand-fg shadow-sm ring-1 ring-inset ring-brand-fg/15 hover:bg-brand/90 hover:shadow-brand",
  secondary:
  ...
  destructive:
    "bg-danger text-danger-foreground shadow-sm ring-1 ring-inset ring-white/15 hover:bg-danger/90 hover:shadow-md",
